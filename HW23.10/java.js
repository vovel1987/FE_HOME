...
let array1 = ["gvg", "hhjgjgj", "bjhhj"];
let array2 = [12, 3, 58, 9, -6, "hufheih"];
let array3 = [true, false];
...
console.log(checkTypeInArray(array2, "number"));
...
let arrayWithThreeElements = function (arrayOne, arrayTwo, arrayThree) {
  ...
  for (let i = 0; i < arrayConcatElements.length; i++) {
    ...
    else if (typeof arrayConcatElements[i] === "number") {
      arrayNumber.push(arrayConcatElements[i]);
    }
    else if (typeof arrayConcatElements[i] === "boolean") {
      arrayBoolean.push(arrayConcatElements[i]);
    // }  else {
    //    arrayAnother.push[i]
    // }
    // if (
    //   typeof arrayConcatElements[i] !== "string" &&
    //   typeof arrayConcatElements[i] !== "number" &&
    //   typeof arrayConcatElements[i] !== "boolean"
    // ) {
